...
{
template<typename T>
using MessageQueue = moodycamel::BlockingReaderWriterCircularBuffer<T>;
...
void runGenerateMessageThread(std::shared_ptr<iothread::MessageQueue<scrooge::CrossChainMessageData>> messageOutput, NodeConfiguration configuration);
